    ...
    <div className="h-[100dvh] w-full flex flex-col bg-fluent-bg text-text-main overflow-hidden relative">
      ...
      <main className="flex-1 overflow-y-auto px-5 pt-10 pb-10 scrollbar-hide flex flex-col items-center">
        ...
        <div className="bg-fluent-card w-full rounded-[32px] p-8 shadow-2xl border border-fluent-accent/10 relative flex flex-col items-center text-center mt-4">
          ...
          <h2 className="text-2xl font-bold text-text-main mb-4">Transaksi Berhasil</h2>
          
          {/* Garis Pemisah (Divider) */}
          <div className="w-16 h-1 bg-fluent-accent rounded-full mb-6"></div>

          <h3 className="text-3xl font-black text-text-main tracking-tight mb-2">Rp291.000</h3>
          <p className="text-sm font-medium text-text-muted mb-10">ID Transaksi #2512007</p>

          {/* Area Feedback */}
          <div className="w-full pt-8 border-t border-white/10 mt-2">
            <p className="text-xs font-bold text-text-main mb-6">
      ...
      <div className="w-full bg-fluent-card/95 backdrop-blur-xl p-5 md:pb-8 pb-5 rounded-t-[32px] shadow-[0_-10px_40px_-10px_rgba(0,0,0,0.5)] border-t border-white/10 z-50 shrink-0">
        <button 
          ...
          className="w-full bg-transparent border-2 border-fluent-accent text-fluent-accent font-bold py-3.5 rounded-2xl flex justify-center items-center space-x-2 hover:bg-fluent-accent/10 transition-colors"
        >
