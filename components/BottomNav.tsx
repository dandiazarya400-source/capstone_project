...
const BottomNav = () => {
  ...
  return (
    ...
    <nav className="absolute bottom-6 left-6 right-6 bg-fluent-card/80 backdrop-blur-xl p-4 rounded-full shadow-[0_10px_25px_-5px_rgba(0,0,0,0.3)] border border-white/10 z-50">
